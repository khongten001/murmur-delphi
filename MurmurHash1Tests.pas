...
type
  [TestFixture]
    ...
    [TearDown]
		procedure TearDown;
    [TestCase('Canonical SMHasher 32-bit','')]
		procedure SelfTest_32_CanonicalSMHasher; //Canonical SMHasher 32-bit
    //[TestCase('useful test vectors of 32-bit','')]
...
procedure TMurmur1Tests.SelfTest_32_CanonicalSMHasher;
const
...
begin
  ...
  WriteLn(
    'Expected: ' + IntToStr(actual) + ' (0x' + IntToHex(actual) +
    ') ; Actual = ' + IntToStr(actual) + ' (0x' + IntToHex(actual) + ')'
  );
...
(*
procedure TMurmur1Tests.SelfTest_32_TestVectors;
var
	ws: UnicodeString;
	t1, t2: Int64;
...
procedure TMurmur1Tests.TearDown;
begin
  inherited;
...
initialization
  TDUnitX.RegisterTestFixture(TMurmur1Tests);
	// TestFramework.RegisterTest('MurmurHash1', TMurmur1Tests.Suite);
